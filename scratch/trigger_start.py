...
# Start Simulation with 5-byte payload to trigger Info telemetry logs
...
# Wait 20 seconds for OTAA joins and telemetry
print("Waiting 20 seconds for OTAA joins and telemetry...")
time.sleep(20)

# Read Docker logs
print("=== DOCKER LOGS ===")
result = subprocess.run(["docker", "logs", "--tail", "40", "chirpstack-simulator-chirpstack-simulator-1"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
print(result.stdout)
print(result.stderr)
